		...
		<div class="citeforge-panel" :class="{ 'is-open': open }">
			...
			<div class="citeforge-panel__body">
						...
						>
							<div class="citeforge-row__title">
								<input
									...
									class="citeforge-row__name-input"
									type="text"
									:value="ref.name || ''"
								...
								<span class="citeforge-row__meta">Uses: {{ refUses(ref) }} <span v-if="ref.group">· {{ ref.group }}</span></span>
							</div>
							...
							<div class="citeforge-row__actions">
								<button class="citeforge-copy-btn" type="button" @click.stop.prevent="copyRefContent(ref)" title="Copy raw content">
				...
				<div class="citeforge-panel__toolbar">
					<button v-if="hasPendingChanges" class="citeforge-tool-btn citeforge-tool-btn--primary" type="button" title="Save pending changes" @click.prevent="saveChanges">
					...
					<button class="citeforge-tool-btn" type="button" title="Mass rename (soon)">
						<span class="citeforge-tool-icon" aria-hidden="true">
